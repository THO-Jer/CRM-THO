            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl max-w-2xl w-full mx-4 max-h-[80vh] flex flex-col shadow-2xl" onClick={e => e.stopPropagation()}>
                ...
                <div className="p-6 pt-4">
                    ...
                    <button onClick={() => fileInputRef.current?.click()} disabled={uploading}
                        ...
                        {uploading ? <span className="text-gray-500 dark:text-gray-400">⏳ Subiendo archivo...</span> : <span className="text-gray-600 dark:text-gray-400">📤 Click para subir archivo</span>}
                    </button>
                                        ...
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center space-x-3 flex-1 min-w-0">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <div className="text-xs text-gray-500 dark:text-gray-400">{formatSize(file.metadata?.size)}{file.created_at && ` • ${new Date(file.created_at).toLocaleDateString('es-CL')}`}</div>
                                                </div>
                                            </div>
