...
export default function ProspectoCard({ prospecto, estados, onMove, onEdit, onDetail, onDelete, onCerrar, onConvert, onHistory }) {
    ...
    const handleMove = (e) => {
        ...
        setMoveTarget('') // reset al placeholder
    }
    ...
    return (
        ...
        >
            ...
            <div className="flex space-x-1 pt-3 border-t border-gray-100 dark:border-gray-700 mt-3">
                <button
                    onClick={(e) => { stop(e); onHistory && onHistory() }}
                    onPointerDown={stop}
                    title="Historial"
                ...
                >🔄</button>
                <button
                    onClick={(e) => { stop(e); onEdit && onEdit() }}
                    onPointerDown={stop}
                    title="Editar"
                    className="flex-1 text-xs text-gray-500 dark:text-gray-400 hover:text-gray-700 py-1 rounded hover:bg-gray-50 dark:hover:bg-gray-700 transition"
                >✏️</button>
            ...
            {showActions && (
                <div className="space-y-2 mt-2 pt-2 border-t dark:border-gray-700">
                    ...
                    <button
                        onClick={(e) => { stop(e); onConvert && onConvert(prospecto, 'ticket'); setShowActions(false) }}
                        onPointerDown={stop}
                    ...
                    <button
                        onClick={(e) => { stop(e); onConvert && onConvert(prospecto, 'keyaccount'); setShowActions(false) }}
                        onPointerDown={stop}
